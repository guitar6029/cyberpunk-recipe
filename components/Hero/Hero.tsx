const Hero: React.FC = () => {
    return (
        <div className="relative flex flex-col items-center justify-center h-[55vh] hero-img ">
            ...
            <div className="relative p-5 w-[fit]  flex flex-col items-center justify-center">
                ...
                <h6 className="z-20 sm:text-xl md:text-xl lg:text-4xl" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}>Forge Your Future: Unleash the Power Within</h6>
            </div>
        </div>
    );
}
